...
class SecondWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        workModeButton.setStyleSheet("background-color:#fff; font-size:25px; border-radius:3px; font-weight:500")
...
"}")
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.rightHand)

        self.leftHand = QtWidgets.QCheckBox(self.mainFrame)
        self.leftHand.setObjectName("leftHand")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.leftHand)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Select The Desired Hand"))
        self.rightHand.setText("Right Hand")
        self.rightHand.setStyleSheet(checkboxStyle+"margin-bottom:10px;margin-top:2px")
